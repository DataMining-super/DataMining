                    ...
                    <div class="col-xl-7 col-12" >
                        <div class="box" style="height:520px;width: 1200px">
                            <div class="box-header with-border">
                                <h4 class="box-title">获取地区信息
                                </h4>
                            </div>
                            <div id="main3" style="height:600px;margin: auto 0"></div>
                        </div>
                    </div>
            ...
            success: function (result) {
                ...
                if(result){
                    for(var i=0;i<result.visitors.length;i++){
                        ...
                        obj.value = result.visitors[i].count;
                        obj.name = result.visitors[i].province;
                        ip_datay[i]=obj;
                    }
                    console.log(ip_datax);
                    console.log(ip_datay);
                    myChart_bar_two.setOption({
                        legend: {
                            orient : 'vertical',
                            x : 'left',
