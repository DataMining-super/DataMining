            ...
            <section class="content">
                <div class="row">
                    <div class="col-xl-7 col-12" >
                        <div class="box" style="height:500px;width: 1200px">
                            <div class="box-header with-border">
                                <h4 class="box-title">前十攻击者
                                </h4>
                            </div>
                            <div id="main" style="height:470px;width: 1200px;margin: 0 auto;"></div>
                        </div>
                    </div>
                    ...
                    <%--<div id="main2" style="height:410px;width: 1200px;margin: 0 auto;"></div>--%>
                    <%--</div>--%>
                    <%--</div>--%>
                    ...
                    <%--<div class="col-xl-5 col-12">--%>
                        ...
                        <%--<div class="box">--%>
                            <%--<div class="box-header with-border">--%>
                                <%--<h4 class="box-title">获取地区信息</h4>--%>
                            <%--</div>--%>
                            <%--<div id="main3" style="height:410px;"></div>--%>
                            <%--<!-- /.box-body -->--%>
                        <%--</div>--%>
                        <%--<!-- /.box -->--%>
                    <%--</div>--%>
